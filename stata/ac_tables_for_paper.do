...
putexcel A1:B1 = "Weighted Descriptives", merge border(bottom) hcenter bold
putexcel B2 = "2014 SIPP"
...
*Income 
* HH
sum thearn_adj if year==(year[_n+1]-1) & SSUID[_n+1]==SSUID & survey_yr==2 & trans_bw60_alt2==1 & bw60lag==0 [aweight=wpfinwgt], detail
putexcel B2=`r(p50)', nformat(###,###)

*Mother
sum earnings_adj if year==(year[_n+1]-1) & SSUID[_n+1]==SSUID & survey_yr==2 [aweight=wpfinwgt], detail 
sum earnings_adj if year==(year[_n+1]-1) & SSUID[_n+1]==SSUID & survey_yr==2 & trans_bw60_alt2==1 & bw60lag==0 [aweight=wpfinwgt], detail 
putexcel B3=`r(p50)', nformat(###,###)

* Race
// tab race [aweight=wpfinwgt], gen(race) - created above

local i=1

foreach var in race1 race2 race3 race4{
	local row = `i'+4
	svy: mean `var' if survey_yr==2 & trans_bw60_alt2==1 & bw60lag==0
