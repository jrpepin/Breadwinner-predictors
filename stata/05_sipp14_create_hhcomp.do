...
collapse (count) minorchildren minorbiochildren preschoolchildren prebiochildren spouse partner hhsize numtype2 (min) youngest_age=childage (max) oldest_age=childage, by(SSUID PNUM panelmonth)
