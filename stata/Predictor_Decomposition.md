...
|	Less than HS	 | <<dd_di: %9.2f $mom_component_1 >>%	| <<dd_di: %9.2f $partner_down_component_1 >>%   | <<dd_di: %9.2f $partner_leave_component_1 >>% | <<dd_di: %9.2f $other_hh_component_1 >>% |
...
|	NH Asian	 	 | <<dd_di: %9.2f $mom_component_r3 >>%	| <<dd_di: %9.2f $partner_down_component_r3 >>% | <<dd_di: %9.2f $partner_leave_component_r3 >>% | <<dd_di: %9.2f $other_hh_component_r3 >>% |
...
|:-------------------|:---------------------------------|:-----------------------------------|:-----------------------------------|
|	Overall	    	 | <<dd_di: %9.2f $total_gap >>%	| <<dd_di: %9.2f $rate_diff >>%      | <<dd_di: %9.2f $comp_diff >>%      |
|	HS or Less		 | <<dd_di: %9.2f $total_gap_e1 >>%	| <<dd_di: %9.2f $rate_diff_e1 >>%   | <<dd_di: %9.2f $comp_diff_e1 >>%   |
|	Some College	 | <<dd_di: %9.2f $total_gap_e2 >>%	| <<dd_di: %9.2f $rate_diff_e2 >>%   | <<dd_di: %9.2f $comp_diff_e2 >>%   |
|	College Plus 	 | <<dd_di: %9.2f $total_gap_e3 >>%	| <<dd_di: %9.2f $rate_diff_e3 >>%   | <<dd_di: %9.2f $comp_diff_e3 >>%   |
