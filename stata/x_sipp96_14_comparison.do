...
tabout bw60 using "$results/overtime_comparison.xlsx", c(freq col) clab(1996 Percent) layout(cb) f(0c 1p) style(xlsx) title(Overall Breadwinner Status - 1996) append
...
tabout trans_bw60 using "$results/overtime_comparison.xlsx", c(freq col) clab(1996 Percent) layout(cb) f(0c 1p) style(xlsx) title(Overall Breadwinner Transitions - 1996) location(55 1) append
...
tabout bw60 using "$results/overtime_comparison.xlsx", c(freq col) clab(2014 Percent) layout(cb) f(0c 1p) style(xlsx) title(Overall Breadwinner Status - 2014) location (1 12) append
...
tabout trans_bw60 using "$results/overtime_comparison.xlsx", c(freq col) clab(2014 Percent) layout(cb) f(0c 1p) style(xlsx) title(Overall Breadwinner Transitions - 2014) location(55 12) append
