...
append using "$SIPP96keep/hh_finsupport1996.dta"
...
tabstat mom_pct dad_pct mom_earn_pct mom_cs_pct dad_earn_pct dad_cs_pct if survey==1, stats(mean p50) // 1996
tabstat mom_pct dad_pct mom_earn_pct mom_cs_pct dad_earn_pct dad_cs_pct if two_parent_hh==1 & survey==1, stats(mean p50)
tabstat mom_pct dad_pct mom_earn_pct mom_cs_pct dad_earn_pct dad_cs_pct if two_parent_hh==0 & survey==1, stats(mean p50)

tabstat mom_pct dad_pct mom_earn_pct mom_cs_pct dad_earn_pct dad_cs_pct if survey==2, stats(mean p50) // 2014
tabstat mom_pct dad_pct mom_earn_pct mom_cs_pct dad_earn_pct dad_cs_pct if two_parent_hh==1 & survey==2, stats(mean p50)
tabstat mom_pct dad_pct mom_earn_pct mom_cs_pct dad_earn_pct dad_cs_pct if two_parent_hh==0 & survey==2, stats(mean p50)

// just earnings - so how does CS change picture?
egen total_earnings = rowtotal(mom_earnings dad_earnings)
